...
import {
  ...
  Switch, ActivityIndicator, Alert, ScrollView, Share,
} from "react-native";
...
function CodeTab({ theme, t }) {
  ...
  const copyCode = () => {
    if (code) Share.share({ message: `Your FocusApp share code: ${code}\n\n${SHARE_DOMAIN}/share/${code}` });
  };
          ...
          {tabs.map(({ key, label, Icon }) => {
            ...
            return (
              ...
              >
                ...
                <Text style={[styles.tabLabel, { color: active ? PRIMARY : "#a0b8d0", fontWeight: active ? "700" : "500" }]}>
                  {label}
                </Text>
              </TouchableOpacity>
            );
...
const styles = StyleSheet.create({
  ...
  codeCard:    { backgroundColor: "#fff", borderRadius: 24, paddingVertical: 32, paddingHorizontal: 36, alignItems: "center", borderWidth: 1.5, borderColor: "#b3cde8", shadowColor: "#4a7ab5", shadowOpacity: 0.28, shadowRadius: 28, shadowOffset: { width: 0, height: 10 }, elevation: 10, marginBottom: 20, alignSelf: "center" },
  codeText:    { fontSize: 24, fontWeight: "800", letterSpacing: 4, marginBottom: 16 },
  brandRow:    { flexDirection: "row", alignItems: "center", gap: 8 },
  brandText:   { fontSize: 15, color: "#333" },
  infoCard:    { backgroundColor: "#fff", borderRadius: 16, padding: 16, alignItems: "center", marginBottom: 16, borderWidth: 1, borderColor: "#e8eef5", shadowOpacity: 0.08, shadowRadius: 12, shadowOffset: { width: 0, height: 3 }, elevation: 3, alignSelf: "center" },
  ...
  timerCard:   { backgroundColor: "#fff", borderRadius: 24, width: "100%", paddingVertical: 28, paddingHorizontal: 20, alignItems: "center", shadowColor: "#000", shadowOpacity: 0.08, shadowRadius: 16, shadowOffset: { width: 0, height: 4 }, elevation: 4 },
